...
class WebuiOperatorCharm(CharmBase):
    ...
    def _configure_workload(self, restart: bool = False) -> None:
        ...
        It detects the changes between the Pebble layer and the Pebble services and applies
        the desired configuration. Then, it restarts the workload if a restart is required.
        """
