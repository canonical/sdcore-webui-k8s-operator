...
class TestCharm:
    ...
    def test_given_webui_service_is_running_db_relations_are_not_joined_and_sdcore_config_relation_is_joined_then_config_url_is_not_published_for_relations(  # noqa: E501
        self,
    ):
        self.harness.set_can_connect(container=CONTAINER, val=True)
        self.harness.add_storage("config", attach=True)
